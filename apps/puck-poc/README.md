...
Phase 0~13 검증을 위한 Registry 기반 Puck Editor와 독립 Project Renderer 앱입니다.
...
- Desktop / Tablet / Mobile breakpoint별 Grid columns / gutter / margin 설정
- Responsive Preview 전환과 Project Renderer breakpoint 렌더링
- Tablet / Mobile Card span Override와 Desktop 변경값 상속
- Mobile 기본 Auto Stack 및 Overflow clamp
...
- Spacing / Radius / Shadow / Typography Design Token selector
- Puck Canvas와 독립 Renderer의 공통 Token resolver
- Theme color token과 Clean Light / Clean Dark palette
- Clean / Soft / Business / Compact / Glass style preset
...
- Project Node Tree Structure Panel과 Component 이름 표시
- Tree Expand / Collapse와 Canvas ↔ Tree 선택 동기화
- Tree Up / Down Reorder의 Canvas 및 Project JSON 반영
- Structure Tree의 Lock 상태 표시와 잠긴 Node 이동 보호
