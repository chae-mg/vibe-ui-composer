...
export const componentRegistry: ComponentDefinition[] = [
  ...
  },
  {
    ...
    icon: "card",
    category: "layout",
    defaultProps: { title: "Card", body: "Card content", span: 6, tabletSpan: 6, mobileSpan: 4, background: "theme.surface", textColor: "theme.text", border: "theme.border", radius: "radius.md" as RadiusToken, shadow: "shadow.sm" as ShadowToken, typographyRole: "title" as TypographyRole, content: [] },
