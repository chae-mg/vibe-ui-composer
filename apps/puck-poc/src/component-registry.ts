...
export const componentRegistry: ComponentDefinition[] = [
  ...
  },
  {
    ...
    icon: "section",
    category: "layout",
    defaultProps: { title: "Section", tone: "surface", background: "theme.surface", textColor: "theme.text", border: "theme.border", radius: "radius.lg" as RadiusToken, shadow: "shadow.none" as ShadowToken, typographyRole: "heading-2" as TypographyRole, content: [] },
  ...
  },
  {
    ...
    icon: "card",
    category: "layout",
    defaultProps: { title: "Card", body: "Card content", span: 6, tabletSpan: 6, smallSpan: 4, background: "theme.surface", textColor: "theme.text", border: "theme.border", radius: "radius.md" as RadiusToken, shadow: "shadow.sm" as ShadowToken, typographyRole: "title" as TypographyRole, content: [] },
    ...
    propertySchema: {
      ...
      smallSpan: { type: "number", label: "Mobile span", min: 1, max: 4 },
      background: { type: "text", label: "Background" },
      textColor: { type: "text", label: "Text color" },
      border: { type: "text", label: "Border color" },
      radius: { type: "select", label: "Radius", options: RADIUS_OPTIONS },
