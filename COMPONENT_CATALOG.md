...
| Section | layout | 가능 | title, tone, background, textColor, border, radius, shadow, content |
...
| Card | layout | 가능 | title, body, span, responsive span, background, textColor, border, radius, shadow |
