...
Phase 13 Structure Panel까지 구현을 진행했습니다. `apps/puck-poc`에서 Registry 기반 14개 Component, Registry 제약을 반영한 Puck Slot, 앱 소유 Project JSON v1, 독립 Renderer, Desktop / Tablet / Mobile Grid 설정과 breakpoint Preview, Flex / Stack / CSS Grid Layout, 선택 Component의 속성 탭 편집, breakpoint별 Card span Override와 Mobile Auto Stack, Spacing / Radius / Shadow / Typography Token, 전역 Theme / Style / Built-in Preset, Block Library와 Layout Preset, Runtime Undo / Redo, 선택 Node Duplicate / Delete / Lock, Project Node Tree, Tree 선택 동기화, Expand / Collapse, Tree Reorder를 확인할 수 있습니다. History는 브라우저 재시작 시 초기화되고 최신 Project만 복원합니다. Schema 기준은 [SCHEMA_SPEC](./SCHEMA_SPEC.md), Component 정의는 [COMPONENT_CATALOG](./COMPONENT_CATALOG.md), 실행 방법은 [PoC README](./apps/puck-poc/README.md)를 참고하세요. 다음 단계는 Phase 14 Local Persistence입니다.
